...
import com.acxiom.librarymgmt.adapters.MembershipAdapter;
...
public class MasterMembershipsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("Master List of Memberships");
    ...
    private void setupHeader() {
        ...
        addHeaderText(header, "Mem. Id", 100);
        addHeaderText(header, "Name", 150);
        addHeaderText(header, "Contact", 100);
        addHeaderText(header, "Address", 150);
        addHeaderText(header, "Aadhar No", 120);
        addHeaderText(header, "Start Date", 100);
        addHeaderText(header, "End Date", 100);
    ...
    private void setupSideNav() {
        ...
        findViewById(R.id.nav_memberships).setOnClickListener(v -> {});
    ...
    private void loadData() {
        ...
        firebaseHelper.getDb().collection(Constants.MEMBERSHIPS).get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    progressBar.setVisibility(View.GONE);
                    membershipList.clear();
                    for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
                        membershipList.add(doc.toObject(Membership.class));
                    }
                    adapter.notifyDataSetChanged();
                    tvNoRecords.setVisibility(membershipList.isEmpty() ? View.VISIBLE : View.GONE);
                })
