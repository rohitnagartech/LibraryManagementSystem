...
public class MasterBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("Master List of Books");
    ...
    private void setupSideNav() {
        findViewById(R.id.nav_books).setOnClickListener(v -> {}); // Current
